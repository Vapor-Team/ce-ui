      ...
      <template v-for="(item,index) in list">
        ...
        <ul :key="index" class="ce-nav__items">
          <template v-if="item.items">
            <li v-for="(navItem,key) in item.items" :key="key" class="ce-nav__item">
              <router-link class="ce-nav__page" :to="navItem.name.toLowerCase()">{{ navItem.title }}</router-link>
            </li>
          </template>
          <li v-for="(group,groupKey) in item.groups" :key="groupKey" class="ce-nav__item active">
