<template>
  <div :class="[ 'ce-base-card', 'ce-base-card--radius', cardThemeClass, ...boxShadow ]">
    <div v-if="$slots.header" class="ce-base-card__header">
      <slot name="header"></slot>
    </div>
    <div class="ce-base-card__body" :style="bodyStyles">
      <slot name="body"></slot>
    </div>
    <div v-if="$slots.footer" class="ce-base-card__footer ce-base-card__footer--content">
